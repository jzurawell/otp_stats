OtpStats::Application.routes.draw do
  #get "welcome/index"
  ...
  get 'recent_tasks' => 'recent_tasks#recent_tasks'
  ...
  get 'transcriptions' => 'transcriptions#transcriptions'
  get 'members_joined' => 'joins#joins'
